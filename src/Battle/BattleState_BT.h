...
#include <vector>
#include <memory>
#include <QPixmap>  // Include for handling QPixmap images
#include <QLabel>  // Include for displaying frames on QLabel
#include <QTimer>
...
private:
    ...
    QLabel* throwLabel;  // Example: QLabel to display the frames
};
