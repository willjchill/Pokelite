...
void BattleSequence::startBattle(Player* player, Player* enemy, BattleSystem* bs)
{
    ...
    QString enemySpritePath = ":/game_logic/sprites/006_charizard/front.png";
    if (enemyPokemon) {
...
void BattleSequence::playerChoseMove(int moveIndex)
{
    ...
    if (battleSystem->isBattleOver()) {
        ...
        setBattleText(winner == gamePlayer ? "The foe fainted!" : battleSystem->getPlayerPokemonName() + " fainted...");
        startTextAnimation();
